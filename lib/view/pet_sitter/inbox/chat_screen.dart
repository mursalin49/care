...
// --- Controller Class ---
class SitterChatScreenController extends GetxController {
  final RxList<SiterChatMessage> messages = <SiterChatMessage>[
    SiterChatMessage(
      id: '1',
...
// --- View Class ---
class SiterChatScreen extends StatefulWidget {
  final String contactName;
  final String contactImage;

  const SiterChatScreen({
    super.key,
  ...
  @override
  State<SiterChatScreen> createState() => _ChatScreenState();
}

class _ChatScreenState extends State<SiterChatScreen> {
  late SitterChatScreenController controller;
  ...
  void initState() {
    super.initState();
    controller = Get.put(SitterChatScreenController());
  ...
  Widget _buildMessageBubble(SiterChatMessage message) {
