...
class SitterBottomNavScreen extends StatefulWidget {
  const SitterBottomNavScreen({super.key});

  @override
  State<SitterBottomNavScreen> createState() => _SitterBottomNavScreenState();
}

class _SitterBottomNavScreenState extends State<SitterBottomNavScreen> {
  int selectedIndex = 0;
