...
class SitterNewPasswordScreen extends StatefulWidget{
  const SitterNewPasswordScreen({super.key});

  @override
  State<SitterNewPasswordScreen> createState() => _SitterNewPasswordScreenState();
}

class _SitterNewPasswordScreenState extends State<SitterNewPasswordScreen> {
