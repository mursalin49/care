...
import 'package:petcare/view/services/boarding/widget/sitters_profile_card.dart';
import 'package:petcare/view/services/dog%20walking/dog_filtering_screen.dart';
import 'package:petcare/view/services/doggy%20day%20care/day_care_filtering_screen.dart';
import '../../../utils/app_colors.dart';
import 'package:get/get.dart';

class DogWalkingSittersScreen extends StatelessWidget {
  const DogWalkingSittersScreen({super.key});
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        InkWell(
                          onTap: () {
                            Get.to(() => DogWalkingFilteringScreen());
                          },
                          child: SvgPicture.asset(
